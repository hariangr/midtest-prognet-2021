...
class KartuStudiDt extends TableComponent
{
    use HtmlComponents;
    ...
    {
        return KartuStudi::where('kelas_id', $this->kelas);
    }
    ...
    public function columns(): array
    {
        return [
            Column::make('ID')
                ->searchable()
                ->sortable(),
            Column::make('Nama Mahasiswa')
                ->searchable()
                ->sortable()
                ->format(function (KartuStudi $model) {
            ...
            Column::make('Actions')
                ->format(function (KartuStudi $model) {
                    return View('components.actions.table-kartustudi-actions', compact('model'));
                })
        ];
    }
}
